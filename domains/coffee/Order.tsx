    ...
    <>
      ...
      <div className="mb-16">
        <div className="flex items-center justify-center">
          <UniqueText Tag="span" size="md" font="sans" className="mr-4" style={{ width: '4.35rem' }}>
            총 인원 :
          </UniqueText>
          <UpDownButton handleIncrease={handleTotalIncrease} handleDecrease={handleTotalDecrease} count={totalCnt} />
        </div>

        <div className="flex items-center justify-center pt-4">
          <UniqueText Tag="span" size="md" font="sans" className="mr-4 text-right" style={{ width: '4.35rem' }}>
            꽝 :
          </UniqueText>
